...
def yolo_coco_val(DFjdict, data, save_dir, is_coco, dataloader):
    # Data
    ...
    if len(jdict):
        ...
        try:  # https://github.com/cocodataset/cocoapi/blob/master/PythonAPI/pycocoEvalDemo.ipynb
            ...
            if is_coco:
                # it should be fine to use either dataloader as the valid image ids come from the same valid set
                # TODO: get imgids from dfine valid loader
